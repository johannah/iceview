...
slow and memory intensive \cite{Lucas81aniterative, Barnea}.  Feature
...
Currently, most approaches use invariant features. This method works 
by identifying the interesting regions and then describing a patch 
around the feature or keypoint with a local descriptor which can 
...
to describe a keypoint in a manner that was rotationally invariant \cite{gausskpt}.  In 2004, Lowe extended this to scale invariance with his SIFT approach which is still widely used today and will be 
